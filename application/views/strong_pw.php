<div class="panel panel-default">
    <div class="panel-heading">
         <h3 class="panel-title">Strong Passwords <a href="<?php echo site_url('app/strong') ?>"><i class="fa fa-file-code-o"></i></a></h3>
    </div>
...
<script type="text/javascript">
    document.getElementById('txt_strong_pw_0').value = decode64("<?php echo $strong1 ?>");
    document.getElementById('txt_strong_pw_1').value = decode64("<?php echo $strong2 ?>");
    document.getElementById('txt_strong_pw_2').value = decode64("<?php echo $strong3 ?>");
</script>