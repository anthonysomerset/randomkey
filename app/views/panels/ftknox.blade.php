...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Ft. Knox Passwords <a href="/ftknox"><i class="fa fa-file-code-o"></i></a></h3>
    </div>
...
<script type="text/javascript">
    document.getElementById('txt_ft_knox_pw_0').value = decode64("{{ $keys[0] }}");
    document.getElementById('txt_ft_knox_pw_1').value = decode64("{{ $keys[1] }}");
    document.getElementById('txt_ft_knox_pw_2').value = decode64("{{ $keys[2] }}");
</script>